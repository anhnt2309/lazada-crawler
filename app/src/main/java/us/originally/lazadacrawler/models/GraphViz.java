...
public class GraphViz {
    ...
    public GraphViz(Context context) {
        mContext = context;
    ...
    private byte[] get_img_stream(File dot, String type) {
        ...
        try {
            img = File.createTempFile("graph_", "." + type, new File(filepath));
            ...
            if (ioe instanceof IOException) {
                System.err.println("Error:    in I/O processing of tempfile in dir " + filepath + "\n");
    ...
    private File writeDotSourceToFile(String str) throws java.io.IOException {
        File temp;
        try {
            temp = File.createTempFile("dorrr", ".dot", new File(filepath));
